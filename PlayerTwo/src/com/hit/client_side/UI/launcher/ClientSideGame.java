...
import com.hit.utility.files.FileLoader;
...
public enum ClientSideGame {
	...
	private ClientSideGame(Substate substate, Dimension dim, Range<Double> responseTime, Dimension boardSize) {
