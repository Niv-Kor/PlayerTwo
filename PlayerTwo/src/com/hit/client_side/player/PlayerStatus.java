...
public class PlayerStatus
{
	...
	private ClientSideProtocol clientSideProtocol;
	
	public PlayerStatus(boolean human) throws IOException {
		this.isHuman = human;
		this.clientSideProtocol = new ClientSideProtocol(true);
	 ...
	 */
	public ClientSideProtocol getProtocol() { return clientSideProtocol; }
}